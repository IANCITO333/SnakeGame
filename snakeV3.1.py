...
def main_menu():
    ...
    while True:
        ...
        record_surface = menu_font.render(
            'Press R to Show High Score', True, white)
        ...
        game_window.blit(
            record_surface, (frame_size_x / 3, frame_size_y / 2.1))
        game_window.blit(exit_surface, (frame_size_x / 3, frame_size_y / 1.8))
...
def show_record():
    while True:
        ...
        back_surface = record_font.render(
