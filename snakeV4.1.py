...
def play_menu_music():
    # Replace 'menu_music.mp3' with your music file
...
def main_menu():
    global snake_color
    play_menu_music()
    menu_options = ["Play Game", "Change Color", "Show High Score", "Exit"]
    selected_option = 0
            ...
            if event.type == pygame.QUIT:
                ...
                if event.key == pygame.K_DOWN:
                    ...
                    if selected_option == 0:  # Play Game
                        ...
                        change_color_menu()
                    elif selected_option == 2:  # Show High Score
                        show_record()
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if event.key == pygame.K_DOWN:
                    ...
                    return  # Return to main menu immediately after selecting a color
